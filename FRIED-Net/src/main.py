...
parser.add_argument('--train_filename', type=str, default="train_15dB_aperi_10L.h5", help='train data file')
parser.add_argument('--test_filename', type=str, default="test_15dB_aperi_10L.h5", help='test data file')
...
if os.path.exists(checkpoint_path):
    ...
    prms['device'] = torch.device("cuda:1")
